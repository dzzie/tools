...
'or decode...because i am quite often a fool :Þ
...
Public Sub Decode(ByRef FileIn() As Byte, ByRef out() As Byte)
    Dim inp(3) As Byte
    ...
    BytesOut = ((Lenght / 4) * 3) - pad ' how many bytes will the decoded string have
    ReDim out(BytesOut)
